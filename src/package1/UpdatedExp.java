...
//				
                ...
                List<WebElement> wbele1 = driver.findElements(By.xpath("//table[@id='grid-1']/tbody/tr"));
                int rowcnt=wbele1.size();  
                System.out.println(rowcnt);
              for (int i = 2; i <=rowcnt; i++) {
            	  
            	  WebElement wbele2 = driver.findElement(By.xpath("//table[@id='grid-1']/tbody/tr["+i+"]/td[3]"));
            	//table[@id='grid-1']/tbody/tr[2]/td[3]
            	  wbele2.click();
  				...
  				wbele.clear();
  				driver.findElement(By.id("custom_expected")).sendKeys("updated the all exp result");
